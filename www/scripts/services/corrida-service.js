...
angular.module("starter").factory("corridaService", function($http, config) {
    ...
    var _salvar = function(callBackSuccess, callBackError) {
        ...
        db.getDB().get("cliente", function callback(err, result) {
            ...
            corrida.cliente = doc;
            console.log(corrida);
            corrida.telefone = corrida.cliente.telefone;
            corrida.cliente.empresa = null;
            ...
            $http.post(config.baseUrl + "corridas", corrida)
                .then(
                    function(success) {
                        ...
                        console.log(success);
                        self.corridaAtiva = success.data;
                        _limpar();
    ...
    var _getCorridaAtiva = function() {
        return self.corridaAtiva;
    };
    ...
    return {
        ...
        getCorridaAtiva: _getCorridaAtiva,
