angular.module("starter").controller('registerController', function($scope, $ionicHistory, $ionicSideMenuDelegate, $state, $ionicModal, $timeout, $ionicLoading, registerService, ionicToast) {
    var self = this;
