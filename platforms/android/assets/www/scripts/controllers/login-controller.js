angular.module("starter").controller('loginController', function($scope, $ionicHistory, $state, $ionicModal, $timeout, $ionicLoading, loginService, PushTokenService, ionicToast, $ionicSideMenuDelegate) {
    var self = this;
    ...
    self.loginComum = function() {
        ...
        loginService.getCliente(self.usuario, self.senha).success(function(data) {
            ...
            if (data) {
                ...
                showToast('Combinação de usuário e senha não existe.', 'bottom', 2500);
            }
            ...
            showToast('Não foi possível fazer o login. Por favor tente mais tarde.', 'bottom', 2500);
        });
    };
