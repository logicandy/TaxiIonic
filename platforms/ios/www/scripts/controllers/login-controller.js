angular.module("starter").controller('loginController', function($scope, $ionicHistory, $state, $ionicModal, $timeout, $ionicLoading, loginService, PushTokenService, ionicToast) {
    var self = this;
